...
#ifndef STATEMENTOFPREPROCESSORLINE_H_INCLUDED
#define STATEMENTOFPREPROCESSORLINE_H_INCLUDED
 ...
 */
class StatementOfPreprocessorLine
: public StatementsBuilder
{
  public:

    StatementOfPreprocessorLine(Statement& statement,
...
#endif // STATEMENTOFPREPROCESSORLINE_H_INCLUDED
