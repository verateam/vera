...
#ifndef STATEMENTOFASSIGN_H_INCLUDED
#define STATEMENTOFASSIGN_H_INCLUDED
 ...
 * of Statements of type "OperatorAssign".
 */
class StatementOfAssign
: public StatementsBuilder
{
  public:

    StatementOfAssign(Statement& statement,
...
#endif // STATEMENTOFASSIGN_H_INCLUDED
