...
#ifndef STATEMENTOFPREPROCESSORDIRECTIVES_H_INCLUDED
#define STATEMENTOFPREPROCESSORDIRECTIVES_H_INCLUDED
 ...
 */
class StatementOfPreprocessorDirectives
: public StatementsBuilder
{
  public:

    StatementOfPreprocessorDirectives(Statement& statement,
...
#endif // STATEMENTOFPREPROCESSORDIRECTIVES_H_INCLUDED
