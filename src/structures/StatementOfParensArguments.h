...
#ifndef STATEMENTOFPARESNARGUMENTS_H_INCLUDED
#define STATEMENTOFPARENSARGUMENTS_H_INCLUDED
 ...
 */
class StatementOfParensArguments
: public StatementsBuilder
{
  public:

    StatementOfParensArguments(Statement& statement,
...
#endif // STATEMENTOFPARENSARGUMENTS_H_INCLUDED
