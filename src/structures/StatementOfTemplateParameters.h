...
#ifndef STATEMENTOFTEMPLATEPARAMETERS_H_INCLUDED
#define STATEMENTOFTEMPLATEPARAMETERS_H_INCLUDED
 ...
 */
class StatementOfTemplateParameters
: public StatementsBuilder
{
  public:

    StatementOfTemplateParameters(Statement& statement,
...
#endif // STATEMENTOFTEMPLATEPARAMETERS_H_INCLUDED
