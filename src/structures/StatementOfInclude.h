...
#ifndef STATEMENTOFINCLUDE_H_INCLUDED
#define STATEMENTOFINCLUDE_H_INCLUDED
 ...
 * of include type.
 */
class StatementOfInclude
: public StatementsBuilder
{
  public:

    StatementOfInclude(Statement& statement,
...
#endif // STATEMENTOFINCLUDE_H_INCLUDED
