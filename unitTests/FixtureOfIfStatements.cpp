...
FixtureOfIfStatements::SetUp()
{
  ...
  ifScope_.tokenSequence_.push_back(Token("return", 1, 29, "return"));
  ifScope_.tokenSequence_.push_back(Token(" ", 1, 35, "space"));
  ifScope_.tokenSequence_.push_back(Token("toupper", 1, 36, "identifier"));

  {
    ifScope_.statementSequence_.push_back(Statement());
    Statement& current = ifScope_.statementSequence_.back();
  ...
  ifScope_.tokenSequence_.push_back(Token(";", 1, 51, "semicolon"));
