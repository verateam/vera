...
FixtureWithFullDocument::SetUp()
{
  ...
  collection_.push_back(Token("//\n", 6, 0, "cppcomment"));
  collection_.push_back(Token("/*ok*/", 7, 0, "ccomment"));
  collection_.push_back(Token("\n", 7, 6, "newline"));
  collection_.push_back(Token("\n", 8, 0, "newline"));
  ...
  collection_.push_back(Token("\n", 31, 5, "newline"));
  collection_.push_back(Token("    ", 32, 0, "space"));
  collection_.push_back(Token("// look at the arg if we can find some options that looks like legacy\n", 32, 4, "cppcomment"));
  collection_.push_back(Token("    ", 33, 0, "space"));
  collection_.push_back(Token("// options\n", 33, 4, "cppcomment"));
...
void
FixtureWithFullDocument::TearDown()
{
}
